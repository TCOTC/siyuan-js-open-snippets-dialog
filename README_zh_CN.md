...
提示：我不懂做插件，不知道怎么让添加的顶栏按钮持续显示，所以每当你开启一次插件就会添加一个按钮，并且重启思源笔记软件后添加的按钮会消失。因此这个插件的作用只是演示代码的作用，如果需要的话请复制下面的 JS 代码，然后添加到 JS 代码片段中。

如果你有能力且愿意帮助我完善插件，请修改代码后向 [代码仓库](https://github.com/TCOTC/siyuan-js-open-snippets-dialog) 提交 [Pull Requests](https://github.com/TCOTC/siyuan-js-open-snippets-dialog/pulls) 或提出 [Issue](https://github.com/TCOTC/siyuan-js-open-snippets-dialog/issues) 。
